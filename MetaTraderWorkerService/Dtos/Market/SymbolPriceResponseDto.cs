...
public class SymbolPriceResponseDto
{
    ...
    [JsonPropertyName("profitTickValue")] public decimal ProfitTickValue { get; set; }

    [JsonPropertyName("lossTickValue")] public decimal LossTickValue { get; set; }

    [JsonPropertyName("timestamps")] public Timestamps Timestamps { get; set; }

    [JsonPropertyName("equity")] public decimal Equity { get; set; }
}
