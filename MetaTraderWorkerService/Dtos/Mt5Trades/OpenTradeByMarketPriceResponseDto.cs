...
public class OpenTradeByMarketPriceResponseDto
{
    ...
    public string OrderId { get; set; } // Unique identifier for the market order

    [JsonProperty("positionId")]
    public string PositionId { get; set; } // Position identifier for the trade

    [JsonProperty("numericCode")]
    public int NumericCode { get; set; } // Numeric result code (e.g., 10009 for success)
    ...
    public string Message { get; set; } // Optional message from the API
    ...
    public DateTime? TradeStartTime { get; set; } // Timestamp when the trade started
}