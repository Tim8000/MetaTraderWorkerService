...
{
    [JsonProperty("symbol")]
    public string Symbol { get; set; } // Trading symbol (e.g., "EURUSD")
    ...
    public decimal? StopLoss { get; set; } // Stop-loss price (optional)

    [JsonProperty("takeProfit")]
    public decimal? TakeProfit { get; set; } // Take-profit price (optional)

    [JsonProperty("clientId")]
    public string ClientId { get; set; } // Client ID for tracking
